...
class Service extends Component
{
	...
	public function createAsset(EmbeddedAsset $embeddedAsset, VolumeFolder $folder): Asset
	{
		...
		$asset = new Asset();
		$asset->title = StringHelper::safeTruncate($assetDbTitle, $pluginSettings->maxAssetNameLength);
